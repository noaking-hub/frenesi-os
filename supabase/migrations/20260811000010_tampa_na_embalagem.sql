-- Mais um item da embalagem aberto: a tampa do decant. Entra na soma de
-- `insumos` como os demais — a coluna de total continua sendo a única que o
-- cálculo de preço lê.

alter table parametros_precificacao
  add column tampa numeric(10, 2) not null default 0;
...
begin
  ...
  insert into parametros_precificacao (
    ...
    insumos, frasco, valvula, tampa, etiqueta, caixa, plastico_bolha,
    ...
    round(p_frasco + p_valvula + p_tampa + p_etiqueta + p_caixa + p_plastico_bolha, 2),
