            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="662" class="win" style="width:662px; border:1px solid #2E2718; border-radius:10px;">
              ...
              <tr>
                <td align="center" class="pad" style="padding:26px 50px 0 50px;">
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:38px; line-height:48px; mso-line-height-rule:exactly; color:#F2ECDF;">{nome}, seus produtos ainda est&atilde;o <em style="font-style:italic; color:#D4AF6A;">guardados</em></div>
                  <div style="font-family:Arial,Helvetica,sans-serif; font-size:15px; line-height:25px; mso-line-height-rule:exactly; color:#A2957F; padding-top:20px;">Os produtos que voc&ecirc; escolheu seguem separados com o seu nome — mas o estoque &eacute; limitado e a reserva n&atilde;o dura para sempre.</div>
                </td>
              </tr>
              ...
              <tr>
                <td align="center" class="pad" style="padding:32px 50px 0 50px;">
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:19px; line-height:26px; font-style:italic; mso-line-height-rule:exactly; color:#D4AF6A;">Sele&ccedil;&atilde;o premium, pronta para envio!</div>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%; background-color:#070605; margin:0; padding:0;">
  <tr>
    <td align="center" style="padding:28px 12px 44px 12px; background-color:#070605;">
      ...
      <span style="display:none; font-size:1px; color:#070605; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">Voc&ecirc; tem {saldo} em cashback na FRENESI — v&aacute;lido at&eacute; {validade}.</span>
        ...
        <tr>
          <td style="padding:8px;">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="662" class="win" style="width:662px; border:1px solid #2E2718; border-radius:10px;">
              ...
              <tr>
                <td align="center" class="pad" style="padding:26px 46px 0 46px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="570" class="win" style="width:570px;">
                    <tr>
                      <td width="60" valign="middle" style="width:60px;"><div style="border-top:1px solid #6B5836; height:1px; line-height:1px; font-size:0;">&nbsp;</div></td>
                      <td align="center" valign="middle" style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A; padding:0 14px;">VOC&Ecirc; TEM SALDO NA FRENESI</td>
                      <td width="60" valign="middle" style="width:60px;"><div style="border-top:1px solid #6B5836; height:1px; line-height:1px; font-size:0;">&nbsp;</div></td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td align="center" class="pad" style="padding:26px 50px 0 50px;">
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:38px; line-height:48px; mso-line-height-rule:exactly; color:#F2ECDF;">{nome}, seu cashback est&aacute; esperando</div>
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:24px; line-height:32px; font-style:italic; mso-line-height-rule:exactly; color:#D4AF6A; padding-top:8px;">e ele tem prazo para ser usado</div>
                  <div style="font-family:Arial,Helvetica,sans-serif; font-size:15px; line-height:25px; mso-line-height-rule:exactly; color:#A2957F; padding-top:20px;">O cashback das suas compras anteriores continua dispon&iacute;vel na sua conta — mas ele expira. D&aacute; para usar em qualquer produto da loja, direto no checkout.</div>
                </td>
              </tr>
              ...
              <tr>
                <td align="center" class="pad" style="padding:10px 32px 0 32px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="598" class="win" style="width:598px; border:1px solid #6B5836; border-radius:12px; background-color:#0D0B08;">
                    <tr>
                      <td align="center" style="padding:28px 30px 30px 30px;">
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A;">O SEU SALDO</div>
                        <div style="font-family:Georgia,'Times New Roman',serif; font-size:26px; line-height:34px; mso-line-height-rule:exactly; color:#F2ECDF; padding-top:14px;">Voc&ecirc; tem para usar agora</div>
                        <div style="padding-top:18px;">
                          <span style="display:inline-block; font-family:Georgia,'Times New Roman',serif; font-size:36px; line-height:44px; mso-line-height-rule:exactly; color:#E7CE9B; border:1px dashed #6B5836; border-radius:8px; padding:14px 36px;">{saldo}</span>
                        </div>
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:20px; mso-line-height-rule:exactly; color:#A2957F; padding-top:16px;">V&aacute;lido at&eacute; <strong style="color:#E7CE9B;">{validade}</strong> &nbsp;&middot;&nbsp; o desconto entra sozinho no checkout</div>
                      </td>
                    </tr>
                  </table>
                </td>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%; background-color:#070605; margin:0; padding:0;">
  <tr>
    <td align="center" style="padding:28px 12px 44px 12px; background-color:#070605;">
      ...
      <span style="display:none; font-size:1px; color:#070605; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">Seu pedido saiu daqui &mdash; o c&oacute;digo de rastreio est&aacute; neste e-mail.</span>
        ...
        <tr>
          <td style="padding:8px;">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="662" class="win" style="width:662px; border:1px solid #2E2718; border-radius:10px;">
              ...
              <tr>
                <td align="center" class="pad" style="padding:26px 46px 0 46px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="570" class="win" style="width:570px;">
                    <tr>
                      <td width="60" valign="middle" style="width:60px;"><div style="border-top:1px solid #6B5836; height:1px; line-height:1px; font-size:0;">&nbsp;</div></td>
                      <td align="center" valign="middle" style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A; padding:0 14px;">PEDIDO {pedido}</td>
                      <td width="60" valign="middle" style="width:60px;"><div style="border-top:1px solid #6B5836; height:1px; line-height:1px; font-size:0;">&nbsp;</div></td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td align="center" class="pad" style="padding:26px 50px 0 50px;">
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:38px; line-height:48px; mso-line-height-rule:exactly; color:#F2ECDF;">{nome}, seu pedido est&aacute; a caminho</div>
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:24px; line-height:32px; font-style:italic; mso-line-height-rule:exactly; color:#D4AF6A; padding-top:8px;">j&aacute; saiu daqui</div>
                  <div style="font-family:Arial,Helvetica,sans-serif; font-size:15px; line-height:25px; mso-line-height-rule:exactly; color:#A2957F; padding-top:20px;">Ele est&aacute; com {transportadora}. O primeiro registro costuma aparecer em at&eacute; um dia &uacute;til depois da postagem &mdash; at&eacute; l&aacute; &eacute; normal a consulta n&atilde;o mostrar movimenta&ccedil;&atilde;o.</div>
                </td>
              </tr>
              ...
              <tr>
                <td align="center" class="pad" style="padding:10px 32px 0 32px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="598" class="win" style="width:598px; border:1px solid #6B5836; border-radius:12px; background-color:#0D0B08;">
                    <tr>
                      <td align="center" style="padding:28px 30px 30px 30px;">
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A;">C&Oacute;DIGO DE RASTREIO</div>
                        <div style="font-family:Georgia,'Times New Roman',serif; font-size:26px; line-height:34px; mso-line-height-rule:exactly; color:#F2ECDF; padding-top:14px;">{transportadora}</div>
                        <div style="padding-top:18px;">
                          <span class="cod" style="display:inline-block; font-family:'Courier New',Courier,monospace; font-size:30px; line-height:38px; letter-spacing:3px; mso-line-height-rule:exactly; color:#E7CE9B; border:1px dashed #6B5836; border-radius:8px; padding:14px 30px;">{codigo}</span>
                        </div>
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:20px; mso-line-height-rule:exactly; color:#A2957F; padding-top:16px;">Toque no bot&atilde;o abaixo &mdash; a p&aacute;gina abre com o c&oacute;digo j&aacute; preenchido</div>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td align="center" class="pad" style="padding:32px 50px 0 50px;">
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:19px; line-height:26px; font-style:italic; mso-line-height-rule:exactly; color:#D4AF6A;">Fracionado do frasco original, lacrado e conferido.</div>
                  <div style="font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:22px; mso-line-height-rule:exactly; color:#A2957F; padding-top:10px;">Se algo chegar diferente do esperado, responda este e-mail que a gente resolve.</div>
                </td>
              </tr>
                ...
                <td align="center" class="pad" style="padding:30px 46px 0 46px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="570" class="win" style="width:570px; border-top:1px solid #2E2718;">
                    <tr>
                      <td align="center" style="padding-top:26px;">
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A;">ATENDIMENTO OFICIAL</div>
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:14px; line-height:23px; mso-line-height-rule:exactly; color:#A2957F; padding-top:10px;">D&uacute;vidas sobre a entrega?<br />Fale com a gente no <a href="https://wa.me/5532998661887" style="color:#D4AF6A; text-decoration:underline;">WhatsApp (32)&nbsp;99866-1887</a>.</div>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td align="center" class="pad" style="padding:16px 40px 40px 40px;">
                  <div style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:18px; mso-line-height-rule:exactly; color:#6E6350;">Voc&ecirc; recebeu este e-mail porque tem um pedido na FRENESI.</div>
                </td>
              </tr>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%; background-color:#070605; margin:0; padding:0;">
  <tr>
    <td align="center" style="padding:28px 12px 44px 12px; background-color:#070605;">
      ...
      <span style="display:none; font-size:1px; color:#070605; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">A entrega do seu pedido foi confirmada.</span>
        ...
        <tr>
          <td style="padding:8px;">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="662" class="win" style="width:662px; border:1px solid #2E2718; border-radius:10px;">
              ...
              <tr>
                <td align="center" class="pad" style="padding:26px 50px 0 50px;">
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:38px; line-height:48px; mso-line-height-rule:exactly; color:#F2ECDF;">{nome}, seu pedido chegou</div>
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:24px; line-height:32px; font-style:italic; mso-line-height-rule:exactly; color:#D4AF6A; padding-top:8px;">entrega confirmada</div>
                  <div style="font-family:Arial,Helvetica,sans-serif; font-size:15px; line-height:25px; mso-line-height-rule:exactly; color:#A2957F; padding-top:20px;">{transportadora} confirmou a entrega. Esperamos que voc&ecirc; goste &mdash; e que o pr&oacute;ximo frasco j&aacute; esteja na sua lista.</div>
                </td>
              </tr>
              ...
              <tr>
                <td align="center" class="pad" style="padding:10px 32px 0 32px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="598" class="win" style="width:598px; border:1px solid #6B5836; border-radius:12px; background-color:#0D0B08;">
                    <tr>
                      <td align="center" style="padding:28px 30px 30px 30px;">
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A;">ENTREGA CONFIRMADA</div>
                        ...
                        <div style="padding-top:18px;">
                          <span style="display:inline-block; font-family:Georgia,'Times New Roman',serif; font-size:34px; line-height:42px; mso-line-height-rule:exactly; color:#E7CE9B; border:1px dashed #6B5836; border-radius:8px; padding:12px 34px;">&#10003; Recebido</span>
                        </div>
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:20px; mso-line-height-rule:exactly; color:#A2957F; padding-top:16px;">Se algo n&atilde;o estiver como voc&ecirc; esperava, responda este e-mail</div>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td align="center" class="pad" style="padding:32px 50px 0 50px;">
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:19px; line-height:26px; font-style:italic; mso-line-height-rule:exactly; color:#D4AF6A;">Obrigado por comprar com a gente.</div>
                  <div style="font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:22px; mso-line-height-rule:exactly; color:#A2957F; padding-top:10px;">Se gostou, conta pra gente &mdash; e se n&atilde;o gostou, conta tamb&eacute;m.</div>
                </td>
              </tr>
                ...
                <td align="center" class="pad" style="padding:30px 46px 0 46px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="570" class="win" style="width:570px; border-top:1px solid #2E2718;">
                    <tr>
                      <td align="center" style="padding-top:26px;">
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A;">ATENDIMENTO OFICIAL</div>
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:14px; line-height:23px; mso-line-height-rule:exactly; color:#A2957F; padding-top:10px;">Alguma coisa fora do lugar?<br />Fale com a gente no <a href="https://wa.me/5532998661887" style="color:#D4AF6A; text-decoration:underline;">WhatsApp (32)&nbsp;99866-1887</a>.</div>
                      </td>
                    </tr>
                  </table>
                </td>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%; background-color:#070605; margin:0; padding:0;">
  <tr>
    <td align="center" style="padding:28px 12px 44px 12px; background-color:#070605;">
      ...
      <span style="display:none; font-size:1px; color:#070605; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">Sua solicita&ccedil;&atilde;o de devolu&ccedil;&atilde;o foi registrada &mdash; o protocolo est&aacute; neste e-mail.</span>
              ...
              <tr>
                <td align="center" class="pad" style="padding:26px 46px 0 46px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="570" class="win" style="width:570px;">
                    <tr>
                      <td width="60" valign="middle" style="width:60px;"><div style="border-top:1px solid #6B5836; height:1px; line-height:1px; font-size:0;">&nbsp;</div></td>
                      <td align="center" valign="middle" style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A; padding:0 14px;">DEVOLU&Ccedil;&Atilde;O &middot; PEDIDO {pedido}</td>
                      <td width="60" valign="middle" style="width:60px;"><div style="border-top:1px solid #6B5836; height:1px; line-height:1px; font-size:0;">&nbsp;</div></td>
                    </tr>
                  </table>
                </td>
                ...
                <td align="center" class="pad" style="padding:30px 46px 0 46px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="570" class="win" style="width:570px; border-top:1px solid #2E2718;">
                    <tr>
                      <td align="center" style="padding-top:26px;">
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A;">ATENDIMENTO OFICIAL</div>
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:14px; line-height:23px; mso-line-height-rule:exactly; color:#A2957F; padding-top:10px;">D&uacute;vidas sobre a devolu&ccedil;&atilde;o?<br />Fale com a gente no <a href="https://wa.me/5532998661887" style="color:#D4AF6A; text-decoration:underline;">WhatsApp (32)&nbsp;99866-1887</a>.</div>
                      </td>
                    </tr>
                  </table>
                </td>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%; background-color:#070605; margin:0; padding:0;">
  <tr>
    <td align="center" style="padding:28px 12px 44px 12px; background-color:#070605;">
      ...
      <span style="display:none; font-size:1px; color:#070605; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">Devolu&ccedil;&atilde;o aprovada &mdash; o c&oacute;digo de postagem est&aacute; neste e-mail.</span>
              ...
              <tr>
                <td align="center" class="pad" style="padding:26px 46px 0 46px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="570" class="win" style="width:570px;">
                    <tr>
                      <td width="60" valign="middle" style="width:60px;"><div style="border-top:1px solid #6B5836; height:1px; line-height:1px; font-size:0;">&nbsp;</div></td>
                      <td align="center" valign="middle" style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A; padding:0 14px;">DEVOLU&Ccedil;&Atilde;O {protocolo}</td>
                      <td width="60" valign="middle" style="width:60px;"><div style="border-top:1px solid #6B5836; height:1px; line-height:1px; font-size:0;">&nbsp;</div></td>
                    </tr>
                  </table>
                </td>
                ...
                <td align="center" class="pad" style="padding:30px 46px 0 46px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="570" class="win" style="width:570px; border-top:1px solid #2E2718;">
                    <tr>
                      <td align="center" style="padding-top:26px;">
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A;">ATENDIMENTO OFICIAL</div>
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:14px; line-height:23px; mso-line-height-rule:exactly; color:#A2957F; padding-top:10px;">D&uacute;vidas sobre a postagem?<br />Fale com a gente no <a href="https://wa.me/5532998661887" style="color:#D4AF6A; text-decoration:underline;">WhatsApp (32)&nbsp;99866-1887</a>.</div>
                      </td>
                    </tr>
                  </table>
                </td>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%; background-color:#070605; margin:0; padding:0;">
  <tr>
    <td align="center" style="padding:28px 12px 44px 12px; background-color:#070605;">
      ...
      <span style="display:none; font-size:1px; color:#070605; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">Sua devolu&ccedil;&atilde;o foi conclu&iacute;da &mdash; os detalhes est&atilde;o neste e-mail.</span>
        ...
        <tr>
          <td style="padding:8px;">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="662" class="win" style="width:662px; border:1px solid #2E2718; border-radius:10px;">
              ...
              <tr>
                <td align="center" class="pad" style="padding:26px 50px 0 50px;">
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:38px; line-height:48px; mso-line-height-rule:exactly; color:#F2ECDF;">{nome}, sua devolu&ccedil;&atilde;o foi conclu&iacute;da</div>
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:24px; line-height:32px; font-style:italic; mso-line-height-rule:exactly; color:#D4AF6A; padding-top:8px;">caso encerrado</div>
                  <div style="font-family:Arial,Helvetica,sans-serif; font-size:15px; line-height:25px; mso-line-height-rule:exactly; color:#A2957F; padding-top:20px;">{corpo}</div>
                </td>
              </tr>
              ...
              <tr>
                <td align="center" class="pad" style="padding:10px 32px 0 32px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="598" class="win" style="width:598px; border:1px solid #6B5836; border-radius:12px; background-color:#0D0B08;">
                    <tr>
                      <td align="center" style="padding:28px 30px 30px 30px;">
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A;">RESOLU&Ccedil;&Atilde;O DA DEVOLU&Ccedil;&Atilde;O</div>
                        <div style="font-family:Georgia,'Times New Roman',serif; font-size:26px; line-height:34px; mso-line-height-rule:exactly; color:#F2ECDF; padding-top:14px;">{resolucao}</div>
                        <div style="padding-top:18px;">
                          <span class="cod" style="display:inline-block; font-family:'Courier New',Courier,monospace; font-size:30px; line-height:38px; letter-spacing:3px; mso-line-height-rule:exactly; color:#E7CE9B; border:1px dashed #6B5836; border-radius:8px; padding:14px 30px;">{destaque}</span>
                        </div>
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:20px; mso-line-height-rule:exactly; color:#A2957F; padding-top:16px;">{nota}</div>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td align="center" class="pad" style="padding:32px 50px 0 50px;">
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:19px; line-height:26px; font-style:italic; mso-line-height-rule:exactly; color:#D4AF6A;">Agradecemos a confian&ccedil;a.</div>
                  <div style="font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:22px; mso-line-height-rule:exactly; color:#A2957F; padding-top:10px;">Qualquer d&uacute;vida sobre a conclus&atilde;o, fale com o atendimento.</div>
                </td>
              </tr>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%; background-color:#070605; margin:0; padding:0;">
  <tr>
    <td align="center" style="padding:28px 12px 44px 12px; background-color:#070605;">
      ...
      <span style="display:none; font-size:1px; color:#070605; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">Precisamos de novas fotos para seguir com a an&aacute;lise da sua devolu&ccedil;&atilde;o.</span>
        ...
        <tr>
          <td style="padding:8px;">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="662" class="win" style="width:662px; border:1px solid #2E2718; border-radius:10px;">
              ...
              <tr>
                <td align="center" class="pad" style="padding:26px 50px 0 50px;">
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:38px; line-height:48px; mso-line-height-rule:exactly; color:#F2ECDF;">{nome}, precisamos de novas fotos</div>
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:24px; line-height:32px; font-style:italic; mso-line-height-rule:exactly; color:#D4AF6A; padding-top:8px;">a an&aacute;lise continua assim que elas chegarem</div>
                  <div style="font-family:Arial,Helvetica,sans-serif; font-size:15px; line-height:25px; mso-line-height-rule:exactly; color:#A2957F; padding-top:20px;">{corpo}</div>
                </td>
              </tr>
              ...
              <tr>
                <td align="center" class="pad" style="padding:10px 32px 0 32px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="598" class="win" style="width:598px; border:1px solid #6B5836; border-radius:12px; background-color:#0D0B08;">
                    <tr>
                      <td align="center" style="padding:28px 30px 30px 30px;">
                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:11px; line-height:16px; mso-line-height-rule:exactly; letter-spacing:4px; color:#D4AF6A;">O QUE PRECISAMOS</div>
                        <div style="font-family:Georgia,'Times New Roman',serif; font-size:26px; line-height:34px; mso-line-height-rule:exactly; color:#F2ECDF; padding-top:14px;">{resolucao}</div>
                        <div style="padding-top:18px;">
                          <span class="cod" style="display:inline-block; font-family:'Courier New',Courier,monospace; font-size:30px; line-height:38px; letter-spacing:3px; mso-line-height-rule:exactly; color:#E7CE9B; border:1px dashed #6B5836; border-radius:8px; padding:14px 30px;">{destaque}</span>
                        </div>
              ...
              <tr>
                <td align="center" class="pad" style="padding:32px 50px 0 50px;">
                  <div style="font-family:Georgia,'Times New Roman',serif; font-size:19px; line-height:26px; font-style:italic; mso-line-height-rule:exactly; color:#D4AF6A;">Estamos aguardando as suas fotos.</div>
                  <div style="font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:22px; mso-line-height-rule:exactly; color:#A2957F; padding-top:10px;">Entre no portal com o protocolo e o e-mail da compra para reenviar.</div>
                </td>
              </tr>
