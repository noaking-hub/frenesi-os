...
export const NAV: GrupoNav[] = [
  ...
  },
  {
    ...
    telas: [
      ...
      { id: 'derivados', label: 'Produtos derivados', href: '/estoque/derivados' },
      { id: 'movimentacoes', label: 'Movimentações', href: '/estoque/movimentacoes' },
      ...
      { id: 'inventario', label: 'Inventário', href: '/estoque/inventario' },
    ],
  },
